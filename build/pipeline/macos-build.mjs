...
import { selectMacSigningMode } from '../modules/platform/mac-signing-resolve.mjs'
...
const result = spawnSync(process.execPath, [resolve(root, 'build', 'build.mjs'), buildMode], {
  cwd: root,
  env: process.env,
  stdio: 'inherit',
})
