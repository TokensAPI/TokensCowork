...
run(process.execPath, [resolve(root, 'build', 'steps', 'plugin-artifacts-fetch.mjs')], root, refreshEnvironment)
run(process.execPath, [resolve(root, 'build', 'steps', 'staging-prepare.mjs')], root, refreshEnvironment)
