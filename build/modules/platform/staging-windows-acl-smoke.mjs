 ...
 *
 *   node build/modules/platform/staging-windows-acl-smoke.mjs <electron.exe 路径>
 *
 * 排查 Windows 沙箱 ACL 启动链问题时使用(见同目录 windows-acl-overlay.mjs)。
 * ============================================================ */
...
if (electronExe === undefined || !existsSync(electronExe)) {
  throw new Error('usage: node build/modules/platform/staging-windows-acl-smoke.mjs <electron-exe>')
}
